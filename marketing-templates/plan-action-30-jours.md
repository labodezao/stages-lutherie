...
- [ ] Demander :
  ...
  - 2-3 photos d'eux avec leur accordéon
  - Autorisation d'utilisation marketing
  - Note sur 5 étoiles
...
- [ ] Sélectionner 50 meilleures photos :
  ...
  - 20 photos "processus" (jour 3-8)
  - 10 photos "après" (instruments terminés)
  - 10 photos "ambiance" (groupe, soirées)
- [ ] Renommer avec convention claire : `stage-2025-10-jour-03-mecanique.jpg`
...
- [ ] **Instagram** :
  ...
  - Bio : "🎵 Créez votre accordéon en 10j | Luthier pro | Saint-Nazaire 🇫🇷"
  - Lien : Linktree vers site d'inscription
- [ ] **Facebook** :
  - Créer Page professionnelle "Stages de Lutherie - Ewen Daviau"
  - Catégorie : Cours et formations
  - Remplir toutes les infos (horaires, localisation, contact)
- [ ] **YouTube** :
  - Créer/optimiser chaîne
  - Banner attractif
...
- [ ] Créer **Google Business Profile**
  ...
  - Adresse : 9 rue Fernand de Magellan, Saint-Nazaire
  - Horaires : Sur rendez-vous / Pendant les stages
  - Photos : 10-15 photos de l'atelier et accordéons
  - Description : Texte de 750 caractères optimisé SEO
- [ ] Ajouter les premiers avis (demander aux anciens stagiaires)
...
- [ ] Photos de l'atelier :
  ...
  - Accordéons en exposition
  - Vue depuis l'entrée
- [ ] Utiliser lumière naturelle
...
- [ ] Article 1 : "Pourquoi fabriquer son propre accordéon diatonique ?"
  - 800-1000 mots
  - 3-5 photos
  - SEO optimisé : mots-clés principaux
- [ ] Article 2 : "10 jours qui changent une vie : témoignages"
  - Compiler 3-4 témoignages complets
  - Photos avant/après
...
- [ ] Filmer présentation courte (2-3min) :
  ...
  - Montrer un accordéon terminé
  - Expliquer le concept du stage en 30 secondes
  - Call-to-action : "Inscrivez-vous !"
- [ ] Éditer avec app gratuite (CapCut, InShot)
...
- [ ] Email : "Nouvelles sessions 2026 - Parlez-en autour de vous !"
  ...
  - Programme de parrainage : "Recommandez un ami = 10% réduction"
  - Code promo personnalisé pour chacun
...
- [ ] Office de Tourisme La Baule / Pornichet
- [ ] 3-5 magasins de musique région nantaise
  - Proposer : flyers, affiche A3, partenariat
- [ ] 2-3 écoles de musique trad
...
- [ ] Créer **Événement Facebook** : "Stage Avril 2026"
  ...
  - Inviter tous les contacts pertinents
...
- [ ] Facebook Ads : Boost du post annonce
  ...
  - Objectif : Trafic vers site inscription
...
- [ ] Préparer communiqué de presse :
  ...
  - Citation d'Ewen
  - 2-3 photos haute qualité
- [ ] Envoyer à :
  - [ ] Ouest-France (édition Saint-Nazaire)
  - [ ] Presse Océan
...
- [ ] Chat widget (Tawk.to gratuit) ou WhatsApp Business
...
- [ ] "Visite de l'atelier en 30 secondes"
...
- [ ] Vérifier analytics :
  ...
  - YouTube Analytics
- [ ] Identifier :
  - Meilleurs posts (likes, partages)
  - Sources de trafic
  - Pages les plus vues
...
- [ ] Préparer programme :
  - 10h-12h : visite atelier
  - 11h : démo courte (30 min)
  - 11h30 : Q&A
  - 12h : apéro convivial
- [ ] Invitation par email/réseaux sociaux
...
- [ ] Planifier mois 2 en se basant sur résultats
...
1. **Ne pas tout faire parfait** - Mieux vaut publier imparfait que pas du tout
2. **Rester régulier** - 3 posts/semaine > 10 posts puis silence
3. **Être authentique** - Votre passion est votre meilleur atout
4. **Demander de l'aide** - Déléguer certaines tâches si possible
5. **Mesurer & ajuster** - Faire plus de ce qui marche
...
- Textes : rédacteurs freelance sur Redacteur.com
...
🚀 **Prêt à démarrer ? Commencez par le Jour 1 dès aujourd'hui !**
