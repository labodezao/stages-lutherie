...
## Lieu
- Atelier : 9 rue Fernand de Magellan, 44600 Saint-Nazaire, France
- Cadre : quartier calme, ~20 min à pied de la mer, accès bus/centre-ville
- Repas & hébergement : non inclus

## Modèles & tarifs (acompte 40 % à l'inscription)
- 21/8 basses – 2820 € – acompte 900 €
- 33/12 basses – 4500 € – acompte 1500 €
- 33/18 basses – 4880 € – acompte 1900 €
- Si l'instrument n'est pas terminé en 10 jours : retour possible lors d'une session ultérieure (80 €/jour atelier + accompagnement)
...
- **Main gauche** : 8 / 12 / 18 basses ; layout Milleret-Pignol / Heim / personnalisé*

- **Mécaniques** : boutons champignon en bois naturel, nacre noire ou nacre blanche  
...
- **Accessoires fournis** : bretelles, sac/housse de transport

- **Accessoires recommandés** : gants fins, lunettes de sécurité, bouchons d'oreilles, vêtements de travail

*Options personnalisées : tarification à confirmer avant préparation.
...
2. Structure bois (MD/MG), ponçage, collage, équerrage, base mécanique
3. Claviers & boutons : axes, ressorts, toucher
4. Mécaniques MD/MG : assemblage complet, réglages hauteurs/courses
5. Soufflets : fabrication, pose, ajustements, étanchéité
6. Grilles & finitions : montage, décor, finitions bois
7. Anches : tri, installation, mise en tension, tests note par note
8. Réglages fins : fuites d'air, mécanique, alignement touches
9. Tests complets MD+MG, confort de jeu, corrections personnalisées
10. Pratique musicale avec intervenant, test final, photos, bilan collectif
...
## Multimédia
- Vidéo de présentation (QR code possible) : https://www.youtube.com/watch?v=DREx2RqMXeU
- Clips audio/vidéo : prévoir un court montage (réglages, tests, jeu final)
- Planches à inclure dans le PDF : grilles numérotées, layouts Heim/Milleret-Pignol/3 rangées, série atelier/ambiance, soufflets, portraits finaux.

## Budget hébergement proche atelier (9 rue Fernand de Magellan)
- Airbnb centre / proche mer (studios, petits apparts, chambres privées) : filtre "max 60 €/nuit", 15–30 min à pied.
- Exemples types :
  - Studio simple proche plage/commerces (~50–80 €/nuit)
  - Petit T2 avec kitchenette (~50–70 €/nuit)
  - Chambres privées économiques (~17–40 €/nuit)
- Hôtels budget (ibis budget, B&B) : centre/gare ~15–25 min à pied
- Résidence jeunes / auberge : ~15–30 min à pied
- Campings en bus/covoiturage 15–30 min : Saint-Brevin-les-Pins, Pornichet, Batz-sur-Mer, Préfailles, Guérande, La Baule  
  _(à compléter avec adresses exactes + temps de trajet vérifiés)_
- Conseils : vérifier frais ménage/service Airbnb, privilégier options sans voiture, filtre "proche centre/plage/transport".

## Logistique & sécurité
- EPI : lunettes de sécurité, gants, protection auditive disponibles
- Ventilation, pauses, hydratation
- Consentement photo/vidéo à signer
- Points de contrôle internes : structure, mécaniques, soufflets, anches, accordage

## Contacts & inscription
- Formulaire + acompte 40 % : https://stages.ewendaviau.com
