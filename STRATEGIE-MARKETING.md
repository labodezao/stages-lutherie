...
- Pas de stratégie de contenu régulier
- Manque de visuels marketing attractifs
...
- [ ] **Ambiance** : moments de convivialité, pauses, soirées musicales
...
4. **Les témoignages** (1min) : 3-4 stagiaires racontent leur expérience
5. **Call-to-action** (30s) : Dates, inscription, contact
...
- [ ] "Guide complet pour choisir son premier stage de lutherie"
...
- [ ] **Blogs de musique traditionnelle** (articles invités)
- [ ] **Médias locaux** : Ouest-France, Presse Océan (reportages)
...
- [ ] **Chat en direct** ou **WhatsApp Business** pour questions immédiates
...
4. **Jour 14** : Offre limitée / urgence (si applicable)
...
- [ ] Contacter offices de tourisme et médias locaux
...
- [ ] Mettre en place système de parrainage
- [ ] Créer bons cadeaux
...
- Événements & salons : 1 500€
- Newsletter & automation : 500€
- Supports print : 1 000€
- Divers : 1 000€
...
1. **Cette semaine** :
   - [ ] Contacter 5 anciens stagiaires pour témoignages
   - [ ] Créer compte Instagram
   - [ ] Activer Google Business Profile

2. **Ce mois** :
   - [ ] Session photo professionnelle atelier
   - [ ] Rédiger premier article de blog
   - [ ] Préparer calendrier éditorial réseaux sociaux

3. **Ce trimestre** :
   - [ ] Lancer première campagne publicitaire
   - [ ] Organiser première journée portes ouvertes
   - [ ] Établir partenariats locaux (2-3 structures)

---

## 📌 Conclusion

Le succès marketing repose sur **3 piliers** :

1. **Visibilité** : être visible là où sont vos futurs stagiaires (réseaux sociaux, Google)
2. **Crédibilité** : témoignages, photos, vidéos qui prouvent la qualité
3. **Conversion** : processus d'inscription fluide, réassurance, urgence

**L'atout majeur** : l'authenticité et la passion d'Ewen pour la transmission. Le marketing doit refléter ces valeurs et créer une connexion émotionnelle avec les futurs stagiaires.

🎯 **Objectif : Passer de quelques inscriptions à des sessions complètes avec liste d'attente !**
