---
layout: default
title: Stages de Lutherie - Accordéon Diatonique
lang: fr
---
...
Découvrez les différentes étapes de fabrication et l'ambiance des stages dans notre [dossier photos](https://github.com/labodezao/stages-lutherie/tree/main/comm).

### Aperçu du processus

![Travail du bois](https://github.com/labodezao/stages-lutherie/blob/main/comm/Jour%202%20(29).jpg?raw=true)
*Travail de précision sur les structures en bois*
...
*Moments d'échange et de partage en soirée*

## 📍 Lieu

**Atelier de lutherie d'Ewen Daviau**  
9 rue Fernand de Magellan  
44600 Saint-Nazaire  
France

Quartier calme, à environ 20 minutes à pied de la mer, avec accès bus et centre-ville.

## 📝 Inscription

<div style="background-color: #f0f0f0; padding: 20px; border-radius: 5px; margin: 20px 0;">
  <h3 style="margin-top: 0;">🎵 Rejoignez l'aventure !</h3>
  <p><strong>Formulaire d'inscription :</strong> <a href="https://stages.ewendaviau.com" target="_blank">stages.ewendaviau.com</a></p>
  <p><strong>Contact :</strong> <a href="mailto:contact@ewendaviau.com">contact@ewendaviau.com</a></p>
  <p><strong>Site web :</strong> <a href="https://ewendaviau.com" target="_blank">ewendaviau.com</a></p>
</div>
...
*Site généré automatiquement à partir du dépôt GitHub [labodezao/stages-lutherie](https://github.com/labodezao/stages-lutherie)*
