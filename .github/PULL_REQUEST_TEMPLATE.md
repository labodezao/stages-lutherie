## Description
<!-- Décrivez brièvement les changements apportés / Briefly describe the changes made -->

## Type de changement / Type of Change
<!-- Cochez les cases appropriées / Check appropriate boxes -->

- [ ] 📝 Documentation (changements aux fichiers markdown / changes to markdown files)
- [ ] 🖼️ Images (ajout ou modification d'images / adding or modifying images)
- [ ] 🌍 Traduction (ajout ou amélioration de traductions / adding or improving translations)
- [ ] 🔧 Configuration (modifications de fichiers de config / config file changes)
- [ ] 🐛 Correction (correction d'erreurs / bug fix)
...
<!-- Lien vers les issues ou discussions / Link to issues or discussions -->
